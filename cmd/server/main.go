// HellGate server (VPS exit): receives AES-encrypted frame batches from
...
import (
	...
	"github.com/payamd/HellGate/internal/exit"
)
...
func main() {
	...
	log.Printf("[exit] tunnel : POST http://YOUR.VPS.IP:%s/tunnel    (this is RELAY_URL in Code.gs)", port)
	if cfg.DebugTiming {
